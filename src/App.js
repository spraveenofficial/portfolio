          ...
          >
            ...
            <div className="main-container">
              <div>
                ...
                >
                  Hi! I am Praveen Kumar Singh from Ghazipur, Uttar Pradesh but
                  currently living in Bengaluru, Karnataka.<br></br>I love to
                  explore new technologies. <br></br>I am final year graduation
                  student of BCA (Computer Application) from <br></br>
                  <span>ACHARYA INSTITUTE OF GRADUATE STUDIES.</span>
                </motion.p>
            ...
            >
              <motion.div variants={socialItemVariants}>
                <SocialCard
                  ...
                  subtext="Send message into my telegram account directly."
                  url="https://t.me/spraveenofficial"
                />
              </motion.div>

              <motion.div variants={socialItemVariants}>
                <SocialCard
                  logo="ri-linkedin-box-fill"
                  heading="Connect Here"
                  subtext="Check out my Linkedln profile."
                  url="https://www.linkedin.com/in/praveen-kumar-singh-a45816132/"
                />
              </motion.div>
              ...
              <motion.div variants={socialItemVariants}>
                <SocialCard
                  ...
                  url="https://github.com/spraveenofficial"
                />
              </motion.div>
              ...
              <motion.div variants={socialItemVariants}>
                <SocialCard
                  ...
                  heading="Follow Me"
                  subtext="Check out my Twitter profile."
                  url="https://twitter.com/spraveenoffice"
                />
              </motion.div>
            </motion.div>
          </div>
