...
export default function ProjectCard({ deviceType }) {
  ...
  const [cards, setCard] = useState([
    {
      title: "DG Billing System",
      info: "This is Scalable Billing System.That's process all the orders at very automated way. It has latest technology used.",
      ...
      btns: [
        {
          name: "Get started",
          url: "https://github.com/spraveenofficial/dhanji"
        },
        {
          name: "Source code",
          url: "https://github.com/spraveenofficial/dhanji"
    ...
    },
    {
      ...
      info: "This is telegram bot. Made to attend all the online classes.",
    ...
    {
      title: "NBC News ",
      info: "This is NBC news clone portal made to improve user accessibility and readability.",
      logo: <Ncloud className="red" />,
      show: false,
      color: "red",
      btns: [
